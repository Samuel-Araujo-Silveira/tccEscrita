...
Após o desenvolvimento do modelo de aprendizado de máquina, torna-se vital averiguar sua eficiência. Para isso, há três importantes passos \cite{kashyap2024precision}: 
...
\begin{itemize}
	...
	\item \textbf{\textit{f1-score}}: Balanceia as duas métrica em um único valor.
\end{itemize}