...
O Mask R-CNN, por sua vez, é uma evolução do R-CNN porque possui duas características adicionais: uma rede treinável de proposta de região e segmentação de instância. 
